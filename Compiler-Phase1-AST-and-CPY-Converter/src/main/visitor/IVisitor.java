...
public interface IVisitor<T> {
    ...
    String visit(IdentifierDeclarator identifierDeclarator);
    ...
    T visit(DesignationInitializerTuple designationInitializerTuple);
    ...
    T visit(CompoundLiteralExpr compoundLiteralExpr);
    T visit(ArrayIndexingExpr arrayIndexingExpr);
    T visit(FunctionCallExpr functionCallExpr);
    T visit(CastExpr castExpr);
    T visit(PrefixUnaryExpr prefixUnaryExpr);
    T visit(SizeOfExpr sizeOfExpr);
    T visit(FuncDefExtDec funcDefExtDec);
