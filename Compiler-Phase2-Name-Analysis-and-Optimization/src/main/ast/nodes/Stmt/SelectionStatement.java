...
public class SelectionStatement extends Stmt {
    ...
    private ArrayList<SymbolTable> elseIfSymbolTables = new ArrayList<>();
    private Stmt elseStmt;
    private SymbolTable elseSymbolTale;
    private int elseLine;
    public SelectionStatement() {}

    public ArrayList<SymbolTable> getElseIfSymbolTables() {
        return elseIfSymbolTables;
    }

    public void addElseIfSymbolTable(SymbolTable symbolTable) {
        this.elseIfSymbolTables.add(symbolTable);
    }
    ...
    public SymbolTable getElseSymbolTale() {
        return elseSymbolTale;
    }

    public void setElseSymbolTale(SymbolTable elseSymbolTale) {
        this.elseSymbolTale = elseSymbolTale;
    }
